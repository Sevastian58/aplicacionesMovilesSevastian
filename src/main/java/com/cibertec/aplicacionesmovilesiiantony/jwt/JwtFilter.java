...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(request.getServletPath().matches("/user/login|/user/forgotPassword|/user/save|/rol/listAll")){
    ...
    public Boolean isEstudiante(){
        return "estudiante".equalsIgnoreCase((String)claims.get("estudiante"));
    }
    public Boolean isProfesor(){
        return "profesor".equalsIgnoreCase((String)claims.get("profesor"));
    }
